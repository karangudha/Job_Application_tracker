...
const Drawer = ({ isOpen, onClose }) => {
    ...
    const filerParams = useSelector((state) => state.job.filerParams);

    const handleChange = (name, value) => {
        const updatedFilerParams = {
            ...filerParams,
            page: 1,
            [name]: value,
        };
        dispatch(setFilterParams(updatedFilerParams));
    };
                ...
                <div className="h-full flex flex-col justify-between text-white-300 text-xl">
                    <div className="flex flex-col items-start px-4">
                        ...
                        <div className="mt-10 flex justify-between items-center gap-4 text-white-300 px-10">
                            <Button content="Apply" handleInput={() => handleSumbit(filterParams)} />
                            <button
                                type="submit"
